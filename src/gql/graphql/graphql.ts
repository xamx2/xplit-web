...
export type CoreTransactionFieldsFragment = { id: number, amount: number, description: string | null, createdAt: string, member: { name: string | null } } & { ' $fragmentName'?: 'CoreTransactionFieldsFragment' };
...
export type TransactionsQuery = { currentUser: { id: number, transactions: Array<{ ' $fragmentRefs'?: { 'CoreTransactionFieldsFragment': CoreTransactionFieldsFragment } }> } };
